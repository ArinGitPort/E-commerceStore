...
('Dreamy Nook', TRUE, 3.00),                         -- ID 2
('Secret Paper Stash (Stationery Tier)', TRUE, 10.00), -- ID 3
('Crafty Wonderland (Tutorial Tier)', TRUE, 15.00),   -- ID 4
('Little Charm Box (Clay Tier)', TRUE, 25.00),        -- ID 5
("Bunni's Enchanted Garden (All-in Tier)", TRUE, 40.00); -- ID 6
