...
CREATE TABLE returns (
  ...
  FOREIGN KEY (order_id)     REFERENCES archived_orders(order_id),
...
ALTER TABLE returns
  ADD COLUMN return_status ENUM('Pending','Approved','Rejected') NOT NULL DEFAULT 'Pending';

ALTER TABLE returns
ADD COLUMN status_history JSON DEFAULT NULL,
ADD COLUMN last_status_update DATETIME DEFAULT NULL;
