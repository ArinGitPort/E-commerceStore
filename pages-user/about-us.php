...
<head>
    <meta charset="UTF-8" />
    <title>About Bunniwinkle - Our Story</title>
...
<body>
    ...
    <section class="about-hero container-fluid d-flex align-items-center">
        <div class="container text-center text-white">
            ...
            <p class="lead animate__animated animate__fadeInUp animate__delay-1s" style="color: white;">Crafting happiness, one cute product at a time</p>
        </div>
    </section>
    ...
    <section class="container py-5">
        <div class="row align-items-center">
            <div class="col-lg-6 animate__animated animate__fadeInLeft mb-4 mb-lg-0">
                <img src="../assets/images/company assets/vintagephoto.png" class="img-fluid rounded shadow our-story-img" alt="Our Beginnings">
            ...
            <div class="col-lg-6 animate__animated animate__fadeInRight" style="margin-top: 2rem;">
                ...
                <p class="lead">Bunniwinkle started in 2018 as a passion project in a tiny home studio.</p>
                <p>What began as handmade gifts for friends quickly grew into a community of customers who loved our unique, heartwarming designs. Today, we're a small but dedicated team committed to spreading joy through our carefully crafted products.</p>
                <div class="signature mt-4">
                    <p class="mb-0">With love,</p>
                    <img src="../assets/images/company assets/signature.png" alt="Founder's Signature" style="height: 50px;">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="mission-section py-5">
        <div class="container text-center">
            <div class="mission-card p-4 p-md-5 rounded shadow animate__animated animate__zoomIn">
                ...
                <p class="mission-statement lead">"To create a heartwarming and enchanting haven for creativity, our cute artist shared space store envisions a world where the charm of adorable artistry brings joy to every corner. We aspire to be a vibrant community that celebrates the magic of cuteness, fostering collaboration among artists and enchanting our customers with a delightful and curated collection of whimsical creations."</p>
            </div>
        </div>
    </section>
