<?php
// admin-notifications-modals.php
?>
<!-- New Notification Modal -->
<div class="modal fade" id="newNotificationModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <!-- Added method="post" so that the form data (including action) is sent correctly -->
      <form method="post" data-ajax action="admin-notifications-handler.php">
                ...
                <div class="list-group list-group-flush">
                  <?php foreach ($membershipTypes as $type): ?>
                    <label class="list-group-item d-flex gap-2">
                      <input class="form-check-input flex-shrink-0" type="checkbox" name="membership_types[]" value="<?= $type['membership_type_id'] ?>">
                      <span>
